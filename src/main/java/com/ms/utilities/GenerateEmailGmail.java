 ...
 *
 */
public class GenerateEmailGmail {
	...
	//	String host = "mta-hub.ms.com";
		...
		//Add sender
		String from = "swapnil.bodade88@gmail.com";
		 final String username = "swapnil.bodade88@gmail.com";//your Gmail username 
		 final String password = "UGl0YW1iZXJAMTIzNDU=";//your Gmail password
		...
		// creating session object to get properties
		 Session session = Session.getInstance(props,
				 ...
				 return new PasswordAuthentication(username, DecodeUtils.getDecodedString(password));
